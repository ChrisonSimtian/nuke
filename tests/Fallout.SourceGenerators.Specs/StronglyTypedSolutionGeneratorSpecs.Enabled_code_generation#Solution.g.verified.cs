...
internal class Solution(SolutionModel model, AbsolutePath path) : Fallout.Solutions.Solution(model, path)
{
    ...
    public __01_test _01_test => Unsafe.As<__01_test>(this.GetSolutionFolder("01-test"));
    public _misc misc => Unsafe.As<_misc>(this.GetSolutionFolder("misc"));

    internal class __01_test(SolutionFolderModel model, Fallout.Solutions.Solution solution) : Fallout.Solutions.SolutionFolder(model, solution)
    {
